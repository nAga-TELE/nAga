...
if text and text:match('^بحث (.*)$') and database:get(bot_id.."dl_yt_dl"..msg.chat_id_) == "open" then 
local TextSearch = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5
local eq = json:decode(https.request("https://black-source.tk/NG/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
print("Ok : "..TextSearch)
end
...
if text == "تفعيل التحقق" and Addictive(msg) and GetSourseMember(msg) then   
if database:get(bot_id.."Chek:Welcome"..msg.chat_id_) then
database:del(bot_id.."Chek:Welcome"..msg.chat_id_)
end
database:set(bot_id.."CAPTCHA"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم تفعيل التحقق") 
return false
end
if text == "تعطيل التحقق" and Addictive(msg) and GetSourseMember(msg) then   
database:del(bot_id.."CAPTCHA"..msg.chat_id_) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم تعطيل التحقق") 
return false
end
...
os.execute('wget https://raw.githubusercontent.com/nAga-TELE/nAga/main/NiggA.lua')
os.execute('wget https://raw.githubusercontent.com/nAga-TELE/nAga/main/start.lua')
dofile('NiggA.lua')  
return false
end
if text == "راسلني" then
...
infovid = "• اختر صيغه التنزيل الان.\n🎬 "..string.sub(objectend.title,0,50).."\n"
keyboard = {} 
keyboard.inline_keyboard = {
...
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. Chat_id .. '&photo='..URL.escape("https://mode-pro.tk/IMG_20210526_032840_154.jpg")..'&caption=' .. URL.escape(infovid).."&reply_to_message_id="..msgidrp.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
https.request("https://black-source.tk/NG/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
print("Ok : Do")
end
Ok_id  = DAata:match("(%d+)")  
